...
namespace Normalization
{
    ...
    private void InitializeComponent()
    {
      ...
      // button_openFolder
      // 
      button_openFolder.Location = new Point(13, 53);
      ...
      // textBox_cutValue
      // 
      textBox_cutValue.Location = new Point(216, 29);
      textBox_cutValue.Margin = new Padding(4);
      textBox_cutValue.Name = "textBox_cutValue";
      textBox_cutValue.Size = new Size(65, 23);
      ...
      // button_execute
      // 
      button_execute.Location = new Point(197, 53);
      ...
      // progressBar
      // 
      progressBar.Location = new Point(14, 86);
      ...
      label_left.Location = new Point(14, 104);
      ...
      // button_clearFiles
      // 
      button_clearFiles.Location = new Point(105, 53);
      ...
      label1.TabIndex = 7;
      label1.Text = "注：仅支持16位立体声PCM";
      // 
      // Form1
      // 
      AutoScaleDimensions = new SizeF(7F, 17F);
      AutoScaleMode = AutoScaleMode.Font;
      ClientSize = new Size(294, 126);
      Controls.Add(label1);
